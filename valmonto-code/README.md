...
- [] Ability to configure LLMs (Supported LLMs / API keys etc / default LLMs etc)
- [] Ability to use TAB completion (should be easily switchable off)
- [] Ability to use CTRL+K feature in files or to selected areas
- [] Ability to apply controlled workflows (Auto file creation / Research etc)
- [] Ability to change custom prompts for any workflows.
